...
error incidents, the slowest web and background actions by daily impact, host
metrics, uptime monitors, job queues, check-ins and the last deploy — with
every row one keypress away from your coding agent.
...
[1.0.0]: https://github.com/memouranga/omarchy-appsignal/releases/tag/v1.0.0
