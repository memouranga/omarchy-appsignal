...
`v1.0` covers an app end to end: alerts, errors, performance, servers, uptime, jobs, check-ins and
deploys. Ideas for later: log incidents, anomaly trigger management, a compact mode for vertical
bars, and per-app section overrides. Issues and pull requests welcome.
